public class App {
    public static void main(String[] args){
        ...
        ⦁	neste diagrama pode ser observado sobrecarga? Sim, na classe cadastro imoveis, método listar.
        ⦁	neste diagrama pode ser observado sobrescrita? Sim, no método abstrato calculaImposto.
        ⦁	qual a implicação da classe Imovel ser abstract? Não poderá ser instanciados objetos do tipo Imovel, apenas Comercial ou Residencial.
